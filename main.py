...
def drawBitmap(w_image):
    print('@Hownone: Please wait for a moment ╰(*°▽°*)╯')
    print('The more colours in the image, the longer it takes! =￣ω￣=')
...
if __name__ == '__main__':
    paser = argparse.ArgumentParser(
        description="Convert an bitmap to SVG and use turtle to draw it.")
    paser.add_argument('filename', type=str,
                       help='The file(*.jpg, *.png, *.bmp) name of the file you want to convert.')
    paser.add_argument(
        "-c", "--color", help="The speed of program depends on your number of the image)", type=int, default=32)
